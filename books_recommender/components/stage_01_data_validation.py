...
class DataValidation:
    ...
    def preprocess_data(self):
        try:
            ratings = pd.read_csv(self.data_validation_config.ratings_csv_file, sep=";", encoding='latin-1', on_bad_lines='warn')
            books = pd.read_csv(self.data_validation_config.books_csv_file, sep=";", on_bad_lines='warn', encoding='latin-1')
